// polygon-clipping 0.15.7 (MIT) - UMD build, vendored with an ESM wrapper.
// The published ESM builds import splaytree/robust-predicates externally, which
// breaks node (no https: imports). This UMD bundle is self-contained.
